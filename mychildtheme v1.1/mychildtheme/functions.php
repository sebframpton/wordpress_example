...
//*********Building a widget called mychildtheme widget**********
  ...
  function childtheme_widget_init() {
...
// Actions
add_action( 'widgets_init','childtheme_widget_init');
...
// Filters that removes some vowels on the page

 function remove_the_vowels( $title ) {
    $title = preg_replace( '/[aei]/i', '', $title );
    return $title;
}
